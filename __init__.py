...
GAP_MODE = ini_read(config_filename, config_section, config_key_gap_mode, '0')=='1'
...
class Command:
    ...
    def config(self):
        ...
        ini_write(config_filename, config_section, config_key_gap_mode, '1' if GAP_MODE else '0')
